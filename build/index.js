...
(async function initApp() {
    ...
    const templates = FilesHandler_1.default.getTemplates(cwd);
    if (!templates.length)
    ...
    const allOptionalFiles = FilesHandler_1.default.getOptionalFiles(pathToTemplate);
    const parameters = {
        name: (_a = args[0]) !== null && _a !== void 0 ? _a : null,
        selectedOptionalFiles: (_b = options.include) !== null && _b !== void 0 ? _b : null,
    };
    ...
    const filesHandler = new FilesHandler_1.default({
        dest,
        ...parameters,
    });
