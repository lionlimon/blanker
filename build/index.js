...
const BlanksHandler_1 = require("./libs/BlanksHandler");
...
(async function initApp() {
    ...
    const templates = BlanksHandler_1.BlanksHandler.getBlanks(cwd);
    if (!templates.length)
    ...
    const allOptionalFiles = BlanksHandler_1.BlanksHandler.getOptionalFiles(pathToTemplate);
    const parameters = {
    ...
    const filesHandler = new BlanksHandler_1.BlanksHandler({
        dest,
        ...parameters,
    });
